      ...
      <nav className="bg-muted/50 px-4 py-3">
        <div className="container mx-auto">
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-foreground font-medium">Professionals</span>
          </div>
        </div>
      </nav>
        ...
        <div className="container mx-auto max-w-6xl">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Browse professionals by category</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                List of professionals will be displayed here.
              </p>
            </CardContent>
          </Card>
        </div>
