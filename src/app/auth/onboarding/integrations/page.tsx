...
export default function OnboardingIntegrationsPage() {
  ...
  // Mock integrations data - Comprehensive project lifecycle management integrations
      ...
      <nav className="bg-muted/50 px-4 py-3">
        <div className="container mx-auto">
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-foreground font-medium">Onboarding - Integrations</span>
          </div>
        </div>
      </nav>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-accent-primary/20 rounded-full mb-6">
              <LinkIcon className="h-10 w-10 text-accent-primary"/>
            </div>
            <h1 className="text-4xl font-display font-bold mb-4">Connect Your Accounts</h1>
          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold">Integration Progress</h3>
