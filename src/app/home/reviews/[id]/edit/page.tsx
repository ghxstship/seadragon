      ...
      <nav className="bg-muted/50 px-4 py-3">
        <div className="container mx-auto">
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <Link href="/home/reviews" className="hover:text-foreground">Reviews</Link>
            <span>/</span>
            <Link href={`/home/reviews/${id}`} className="hover:text-foreground">Review {id}</Link>
            <span>/</span>
        ...
        <div className="container mx-auto max-w-6xl">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Update your review for {id}</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Review edit form will be displayed here.
              </p>
            </CardContent>
          </Card>
        </div>
