...
export default async function TransferReservation({ params }: { params: Promise<{ id: string }> }) {
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Transfer your reservation to another person.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-muted/50">
        <div className="container mx-auto max-w-6xl">
          <Card>
            <CardHeader>
              <CardTitle>Transfer Reservation</CardTitle>
              <CardDescription>Transfer reservation {id} to another person</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Transfer options for reservation {id} will be displayed here.
              </p>
            </CardContent>
          </Card>
        </div>
