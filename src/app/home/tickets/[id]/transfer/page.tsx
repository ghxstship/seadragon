...
export default async function TransferTicket({ params }: { params: Promise<{ id: string }> }) {
        ...
        <div className="container mx-auto max-w-6xl">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Transfer ticket {id} to another person</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Transfer options for ticket {id} will be displayed here.
              </p>
            </CardContent>
          </Card>
        </div>
