...
export default async function TicketQR({ params }: { params: Promise<{ id: string }> }) {
        ...
        <div className="container mx-auto max-w-6xl">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Digital ticket for {id}</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                QR code for ticket {id} will be displayed here.
              </p>
            </CardContent>
          </Card>
        </div>
