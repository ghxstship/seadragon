      ...
      <nav className="bg-muted/50 px-4 py-3">
        <div className="container mx-auto">
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <Link href="/home/wallet/credits" className="hover:text-foreground">Credits</Link>
            <span>/</span>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Purchase platform credits for your account.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Buy platform credits</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Credit purchase options will be displayed here.
              </p>
            </CardContent>
          </Card>
        </div>
