      ...
      <nav className="bg-muted/50 px-4 py-3">
        <div className="container mx-auto">
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <Link href="/home/wallet/rewards" className="hover:text-foreground">Rewards</Link>
            <span>/</span>
            <span className="text-foreground font-medium">Redeem</span>
          </div>
        </div>
      </nav>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Use your loyalty points for rewards.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Use points for rewards</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Reward redemption options will be displayed here.
              </p>
            </CardContent>
          </Card>
        </div>
