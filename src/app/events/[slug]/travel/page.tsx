...
export default async function Travel({ params }: { params: Promise<{ slug: string }> }) {
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          <h1 className="text-5xl md:text-6xl font-display font-bold mb-6">
            Getting There - {eventName}
          </h1>
          <p className="text-xl text-muted-foreground mb-8">
            Travel information and directions to {eventName}.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Travel info and directions</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Travel information, transportation options, and directions will be displayed here.
              </p>
            </CardContent>
          </Card>
        </div>
