...
export default async function VIP({ params }: { params: Promise<{ slug: string }> }) {
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          <h1 className="text-5xl md:text-6xl font-display font-bold mb-6">
            {eventName} VIP Packages
          </h1>
          <p className="text-xl text-muted-foreground mb-8">
            Exclusive VIP options for {eventName}.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          <Card>
            <CardHeader>
              ...
              <CardDescription>VIP options and packages</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                VIP packages and exclusive options will be displayed here.
              </p>
            </CardContent>
          </Card>
        </div>
