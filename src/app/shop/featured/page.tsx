...
import { Search, Filter, Star, Heart, ShoppingCart, Truck, Shield, Award, Zap, Crown, Sparkles, Camera, Music, Lightbulb } from "lucide-react"
...
export default function Featured() {
  ...
  useEffect(() => {
    ...
    const loadProducts = async () => {
      try {
        const res = await fetch('/api/v1/products?featured=true&limit=20')
        if (res.ok) {
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Discover our handpicked selection of premium equipment, trusted by professionals worldwide.
              From cutting-edge technology to time-tested classics, find the perfect tools for your next project.
            </p>
            ...
            <TabsContent value={selectedCategory} className="mt-8">
              <div className="flex items-center justify-between mb-8">
                <div>
                  <h2 className="text-3xl font-display font-bold mb-2">
                    {selectedCategory === "all" ? "All Featured Products" : categories.find(c => c.value === selectedCategory)?.label}
                  </h2>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredProducts.map((product) => (
                  <Card key={product.id} className={`overflow-hidden hover:shadow-xl transition-shadow ${product.featured ? 'ring-2 ring-accent-primary/20' : ''}`}>
                    {/* Product Image */}
